...
/* harmony default export */ __webpack_exports__["default"] = ("@import url(\"https://fonts.googleapis.com/css2?family=Lato:wght@900&display=swap\");\nbody {\n  font-family: \"Lato\", sans-serif;\n  margin: 0px;\n}\n/* Works - pass \"my-custom-class\" in cssClass to increase specificity */\n.my-custom-class .modal-wrapper {\n  background: #fa0f0f;\n}\n.light-text {\n  color: lightgrey;\n}\nion-button {\n  height: 60px;\n  width: 100%;\n  margin: 0px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _address_modal_address_modal_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../address-modal/address-modal.page */ "Xerf");
...
let Tab2Page = class Tab2Page {
    constructor(router, storage, http, userService, productService, io, modalController, alertController, loadingController, platform) {
        this.router = router;
        ...
        this.countChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
        this.slot = {};
        this.cart = [];
        ...
        this.io.on('removecart', (data) => {
            console.log("cart io" + JSON.stringify(data['user']));
            this.getUserCart();
        });
        this.io.on('get:slot', (data) => {
            console.log("Slot ");
            console.log(data);
            this.slots = data;
        });
    ...
    getUserAddresses() {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].API_URL + '/address/' + this.userId).subscribe(address => {
    ...
    getSlot() {
        ...
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].API_URL + '/slot').subscribe(slots => {
            console.log(slots);
    ...
    presentaddressModal() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
                component: _address_modal_address_modal_page__WEBPACK_IMPORTED_MODULE_13__["AddressModalPage"],
    ...
    onPlaceOrder() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].API_URL + '/order', order).subscribe(order => {
    ...
    showOrderPlacedPage() {
        this.userService.getUserById(this.userId).subscribe(user => {
            ...
            this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].API_URL + '/place', body).subscribe(response => {
                if (response) {
    ...
    clearUserCart(orderId) {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].API_URL + '/cart/clear/' + this.userId).subscribe(clearCart => {
            if (clearCart) {
                this.getUserCart();
...
Tab2Page.ctorParameters = () => [
    ...
    { type: _services_product_service__WEBPACK_IMPORTED_MODULE_9__["ProductService"] },
...
Tab2Page.propDecorators = {
    countChanged: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["Output"] }],
    sumOfCart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"] }]
};
